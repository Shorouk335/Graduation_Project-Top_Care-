 ...
 //Notification
  static List <Notification_Model>Notification_List= [
    Notification_Model(name: "Mohammed Ali", Time: "San 5:00 pm",
        IconTxt: "View Result ",img: "assets/images/man.png"),
    Notification_Model(name: "Ahmed Ali", Time: "San 7:00 pm",
        IconTxt: "Wait Result ",img: "assets/images/man.png"),
    Notification_Model(name: "Mohammed Ali", Time: "San 5:00 pm",
        IconTxt: "View Scan   ",img: "assets/images/man.png"),
    Notification_Model(name: "Ahmed Ali", Time: "San 7:00 pm",
        IconTxt: "Reject Order",img: "assets/images/man.png"),
