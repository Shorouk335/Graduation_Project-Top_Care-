      ...
      child: Row(
        children: [
          ...
          Column(
            ...
            children: [
              Text(name!,style: txtStyle(ColorManager.DarkColorOnly, 20.0, true),),
              Text(Time!,style: txtStyle(ColorManager.DGrayBasiColor, 15.0, false),),
            ],
          ),
         Spacer(),
          Column(
            children: [
              ...
              Icon(Icons.check_circle_outline,color: ColorManager.DarkColorOnly,size: 50,),

              Text(IconTxt,style:
               (IconTxt.contains("Reject"))? txtStyle(Colors.red, 15.0, true) :
      ...
      child: Row(
        children: [
          ...
          InkWell(
            ...
            child: Column(
              children: [
                Icon(Icons.check_circle,color: ColorManager.BlueBasiColor,size: 50,),
                Text(IconTxt!,style:
                txtStyle(ColorManager.BlueBasiColor, 15.0, false),),
              ],
            ),
          ),
        ...
        children: [
          ...
          InkWell(
            ...
            child: Column(
              children: [
                Icon(Icons.check_circle,color: ColorManager.BlueBasiColor,size: 50,),
                Text(IconTxt!,style: txtStyle(ColorManager.BlueBasiColor, 15.0, false),),
              ],
            ),
          ),
